...
File: [libholberton.so](libholberton.so/)  -  [holberton.h](holberton.h/)
...
File: [Read Post](https://www.linkedin.com/pulse/differences-between-static-dynamic-libraries-carlos-garcia)
