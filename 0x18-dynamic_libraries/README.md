...
0 - libholberton.so, holberton.h - Create the dynamic library libholberton.so
...
2 - 100-operations.so - I know, you’re missing C when coding in Python. So let’s fix that!
